  ...
  return (
    <div className="app">
      <header className="header">
        <div className="header-mobile-icons-left">
          <a href="mailto:danielhallgren12@gmail.com" title="Email" className="footer-icon-link">
            <span style={{ fontSize: '1.1rem' }}>📧</span>
          </a>
          <a href="https://github.com/danielhallgren12-cloud" target="_blank" rel="noopener noreferrer" title="GitHub" className="footer-icon-link">
        ...
        <h1>Routerino</h1>
        <div className="header-mobile-icons-right">
          <a href="https://paypal.me/DHallgren257" target="_blank" rel="noopener noreferrer" title="Donate" className="footer-donate-btn">
            <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor">
              <path d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944.901C5.026.382 5.474 0 5.998 0h7.46c2.57 0 4.578.543 5.69 1.81 1.01 1.15 1.304 2.42 1.012 4.287-.023.143-.047.288-.077.437-.983 5.05-4.349 6.797-8.647 6.797h-2.19c-.524 0-.968.382-1.05.9l-1.12 7.106zm14.146-14.42a3.35 3.35 0 0 0-.607-.541c1.387 2.654-.186 5.718-3.656 6.787-1.564.48-3.32.576-5.024.576H10.12l-1.355 8.59h3.316a.641.641 0 0 0 .633-.54l.026-.17.5-3.185.032-.213a.641.641 0 0 1 .633-.54h.399c2.589 0 4.612-.528 5.61-2.054.837-1.282 1.063-2.787.73-4.21z"/>
            </svg>
            Donate
          </a>
        </div>
          ...
          <div className="map-container">
            ...
            {!loading && traceData && validHops.length > 0 && (
              <MapContainer ref={mapRef} center={[20, 0]} zoom={2} style={{ height: '100%', width: '100%' }} zoomControl={true} doubleClickZoom={false} scrollWheelZoom={true} touchZoom={true} dragging={true} preferCanvas={true}>
                ...
                <TileLayer attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>' url={mode === 'dark' ? "https://{s}.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}{r}.png" : "https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png"} />
      ...
      <footer className="footer">
        <div className="footer-row-1">
          ...
          <a href="https://paypal.me/DHallgren257" target="_blank" rel="noopener noreferrer" className="footer-donate-btn">
        ...
        <div className="footer-copyright">© 2026 Routerino</div>
      </footer>
    </div>
  )
}
