    ...
    <div className="app">
      ...
      <footer className="footer">
        ...
        <div className="footer-links">
          <a href="mailto:danielhallgren12@gmail.com">
            <span>📧</span> danielhallgren12@gmail.com
          </a>
          <a href="https://github.com/danielhallgren12-cloud" target="_blank" rel="noopener noreferrer">
